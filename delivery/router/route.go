...
func RegisterPath(
	...
	//check in and out
	e.GET("/checkschedule/:id", checkController.GetAllCheck(secret), middlewares.JWTMiddleware())
	e.GET("/checks/:id", checkController.GetCheckById(secret), middlewares.JWTMiddleware())
